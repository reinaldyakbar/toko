                            ...
                            <div class="pd-desc">
                                ...
                                <?php if ($session->get('isLoggedIn')) : ?>
                                    ...
                                    <div class="form-group" id="diskon">
                                        <?= form_label('Masukkan Kode Voucher') ?>
                                        <select class="form-control" id="kode">
                                            <option value="0" id="1">Select Voucher</option>
                                            <?php foreach ($diskon as $d) : ?>
                                                <option value="<?= $d->Besar_diskon ?>"><?= $d->Kode_voucher ?>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<?= $d->Tanggal_akhir_berlaku ?></option>
                                            <?php endforeach ?>
                                        </select>
                                    </div>
                                    <div class="form-group">
...
<script>
    $('document').ready(function() {
        ...
        $("#kode").on('change', function() {
            ...
            var total_harga = (jumlah_pembelian * harga) + ongkir;
            var jumlah_total = total_harga - (total_harga * kode / 100)
